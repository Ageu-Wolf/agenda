...
class Agendamento(models.Model):
    ...
    cliente = models.ForeignKey('clientes.Cliente', verbose_name='Cliente',
                                    help_text='Nome do Cliente', on_delete=models.PROTECT)
    funcionario = models.ForeignKey('funcionarios.Funcionario', verbose_name='Funcionario',
    ...
    valor = models.DecimalField( verbose_name='Valor total',decimal_places=2, max_digits=6, default=0.00)
    status = models.CharField( verbose_name='Status', max_length=1, help_text='Status do agendamento', default='A')
    @property
    def servicos(self):
